...
class PercentageSplit extends StatefulWidget {
  ...
  const PercentageSplit({Key? key, required this.guestInfo, required this.onDone, required this.balance, required this.gradPrice}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Input split percentage',style: AppTextTheme.h3.copyWith(
                    fontSize: 18,
